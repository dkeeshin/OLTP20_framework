...
0003load_test_data.sql script loads test locations and three peer group hosts for testing.  All three peer group IP/host addresses are stored in the setup.hub_peer_group table.  Values are "localhost:50052", "localhost:50053", and "localhost:50054"--localhost: 50051 is stored in setup.hub_profile.  Setup.hub_route is the join between hub_profile and hub_peer_group.
